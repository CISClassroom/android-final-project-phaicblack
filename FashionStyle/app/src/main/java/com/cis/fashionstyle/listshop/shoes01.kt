...
import kotlinx.android.synthetic.main.activity_shoes01.*
import th.ac.kku.cis.mobileapp.fashionstyle.R
import th.ac.kku.cis.mobileapp.fashionstyle.select

class shoes01 : AppCompatActivity() {
    lateinit var mDB: DatabaseReference

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_shoes01)
        ...
        btshoes01.setOnClickListener {
            val builder = AlertDialog.Builder(this@shoes01)
