...
public class adapterhat (val mCtx: Context,
                         var resource:Int,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val icon : ImageView = v.findViewById(R.id.imageViewhat)
        val name : TextView = v.findViewById(R.id.textViewhat1)
        val id: TextView = v.findViewById(R.id.textViewhat2)
