...
import kotlinx.android.synthetic.main.activity_shoes02.*
import th.ac.kku.cis.mobileapp.fashionstyle.R
import th.ac.kku.cis.mobileapp.fashionstyle.select

class shoes02 : AppCompatActivity() {
    lateinit var mDB: DatabaseReference

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_shoes02)
        ...
        btshoes02.setOnClickListener {
            val builder = AlertDialog.Builder(this@shoes02)
