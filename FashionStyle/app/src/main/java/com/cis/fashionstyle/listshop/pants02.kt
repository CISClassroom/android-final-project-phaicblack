...
import kotlinx.android.synthetic.main.activity_pants02.*

import th.ac.kku.cis.mobileapp.fashionstyle.R
import th.ac.kku.cis.mobileapp.fashionstyle.select

class pants02 : AppCompatActivity() {
    lateinit var mDB: DatabaseReference

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pants02)
        ...
        btpant02.setOnClickListener {
            val builder = AlertDialog.Builder(this@pants02)
